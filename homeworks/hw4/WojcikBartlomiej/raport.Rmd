...
Wykres, przedstawia ile bramek zdobył oraz stracił każdy zespół w sezonie 22/23 
Premier League. Uważam, jednak że lepiej zestawić słupki goli zdobytych i straconych
oddzielnie, aby lepiej przedstawić, które zespoły zrobiły lepszą robotę w defensywie, 
a które w ataku.
Link do wykresu: <https://levelup.gitconnected.com/visualising-the-english-premier-league-epl-table-using-python-and-plotly-unlocking-the-power-of-f8c3406d0da5>

<div style="text-align: center;">
  <img src="C:\Users\barte\OneDrive\Pulpit\studia\SEM3\TWD\HW4\WykresPRZED.png" 
  width="600" height="400">
</div>

Ramka danych była umieszczona na stronie.
...
Generowanie interaktywnego wykresu przy użyciu plotly"
``` {r message = FALSE, warning = FALSE}
library(plotly)
...
Tak jak już pisałem wyżej, rozdzieliłem kolumny tak aby łatwiej porównywać dane.
Po najechaniu na dany słupek wyświetla się natomiast informacja jaki to zespół,
czy kolumna przedstawia gole zdobyte czy stracone oraz wyswietla najlepszego strzelca
drużyny (wraz z ilością bramek przez niego zdobytych) w przypadku gdy chodzi o gole zdobyte, a w przypadku goli straconych, bramkarza drużyny.
