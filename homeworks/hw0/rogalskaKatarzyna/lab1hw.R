...
mtcars[1,] #pierwszy wiersz, wszystkie kol
mtcars[1] #pierwsza kol
mtcars[,1] # pierwsza kolumna jako wektor
...
#int,numeric,char,logical,factor
str(mtcars)
...
logs[logs$login=="slap",]->tylkoPietraszko
which.max(table(tylkoPietraszko$host))
