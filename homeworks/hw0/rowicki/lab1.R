...
mtcars[1,]
mtcars[1]  # wyświetla się pierwsza kolumna wraz z rownames
mtcars[,1] # wyświetla się pierwsza kolumna jako wektor
...
# character, numeric, logical, faktory
...
# W jednej kolumnie ramki danych wszystkie wartości muszą mieć ten sam typ