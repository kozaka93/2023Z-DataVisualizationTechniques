...
mtcars[c(2,3), c(1,3)] # c tworzy wektor
mtcars[2:10,1:5] # od:do
mtcars[1,] # wszystkie kolumny

# Pierwszy wiersz, pierwsza kolumna?

mtcars[1,]
mtcars[, 1] # to jest wektor
mtcars[, 1, drop = FALSE] # to jednokolumnowa ramka danych
mtcars[1,1]
...
for (x in top1000passwords) {
  message <- proton(action = "login", login="johnins", password=x)
